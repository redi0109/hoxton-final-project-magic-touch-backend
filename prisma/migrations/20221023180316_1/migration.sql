/*
  ...
  - You are about to drop the column `time` on the `CartItem` table. All the data in the column will be lost.
  - You are about to drop the column `time` on the `BoughtProduct` table. All the data in the column will be lost.
